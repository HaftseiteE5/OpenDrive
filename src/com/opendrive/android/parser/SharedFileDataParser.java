...
public class SharedFileDataParser {

	private FileData mFileData = null;
	private ArrayList<FileData> mFileList= null;
	
	public SharedFileDataParser() {
		// TODO Auto-generated constructor stub
	}

	public ArrayList<FileData> parseResponse(String responseXml, FileData parentFileData) throws IOException {
			...
			while (eventType != XmlPullParser.END_DOCUMENT) {
				...
				case XmlPullParser.START_TAG:
					...
					if (name.equalsIgnoreCase("Directory") || name.equalsIgnoreCase("File")) {
						mFileData = new FileData("", parentFileData);
